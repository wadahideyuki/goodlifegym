...
<ul>
	<?php while ( have_posts() ) : ?>
		...
		<a href="<?php the_field('mediaUrl'); ?>"><?php the_field('mediaName'); ?></a>の
		「<a href="<?php the_field('pageUrl'); ?>"><?php the_field('pageName'); ?>」</a>に掲載されました。
		</li>

	<?php endwhile; ?>
	</ul>
	<ul class="list"> 
            <li><span class="day">2023.08.04</span><span class="txt">GOODLIFE GYM 落合南長崎店 が「<a href="https://fitmap.jp/" target="_blank"> FitMap</a>」の記事「<a href="https://fitmap.jp/magazine/gym/32237/" target="_blank">落合南長崎のジムおすすめ7選｜クーポン・料金比較表・評判付き</a>に掲載されました。</span></li>
