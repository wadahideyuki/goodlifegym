              ...
              <div class="planBox">
                <div class="contWrap is-active">
                  <ul class="planList prm_li">
                    ...
                    <li>
                      <div class="lm_ic">人数限定</div><h3>マンツーマン/セミパ<br class="sp">どっちも通い放題prime</h3><span class="monthly">通常料⾦：59,800円<br class="sp">→期間限定：<em>49,800</em>円(税込)</span>
            ...
            <div class="dateBox">
              ...
              <div class="row">
                ...
                <ul class="column">
                  <li> 
                    <label> 
                      <input name="ご希望の店舗" type="hidden" value="<?php the_field('shopname'); ?>"><?php the_field('shopname'); ?>
                    </label>
                  </li>
                </ul>
              </div>
            ...
            <div class="last_cb"> 
              ...
              if ($current_slug === 'ochiaiminami') :
                ?>
                  ...
                  <div class="s"></div>
                  <button type="submit" data-formrun-error-text="未入力の項目があります" data-formrun-submitting-text="送信中..." onclick="gtag('event', 'contact', {'event_category': 'contact','event_label': 'contact','value': 'contact'});">送信</button><script>
                    var directoryPath = window.location.pathname;
                    directoryPath = directoryPath.replace(/^\/|\/$/g, '');
                    var eventName = "shopPageView_" + directoryPath;
                    console.log(eventName);
                    function loadFinished() {
                      gtag("event", eventName, { event_category: "shopPageView", event_label: directoryPath });
                    }
                  ...
                  <button type="submit" data-formrun-error-text="未入力の項目があります" data-formrun-submitting-text="送信中..." onclick="gtag('event', 'contact', {'event_category': 'contact','event_label': 'contact','value': 'contact'});">送信</button><!--#include virtual="/common/include/storetag.html" -->
              <?php endif; ?>
          </form>
        </div>
      </div>
